...
Здесь собраны основные направления моей работы: веб-разработка, десктопные и серверные приложения, администрирование Linux-инфраструктуры и практический опыт работы с нейросетями. Ниже краткий обзор с разбивкой по категориям, подробности и код по каждому направлению смотрите в соответствующих репозиториях.
